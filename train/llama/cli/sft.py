...
from llama.utils import get_strategy,get_model_and_tokenizer
from llama.data import SFTDataset
from llama.trainer import SFTTrainer
...
def train(args):
   ...
   # 创建数据集
    ...
    train_dataset = SFTDataset(args.train_dataset,max_examples=args.max_examples,tokenizer=tokenizer,
                                    cutoff_length=args.max_len,prompt_key=args.prompt,
                                    query_key=args.query,output_key=args.output)
    ...
    eval_dataset = SFTDataset(args.eval_dataset,max_examples=args.max_examples,tokenizer=tokenizer,
                                    cutoff_length=args.max_len,prompt_key=args.prompt,
                                    query_key=args.query,output_key=args.output)
...
if __name__ == "__main__":
    ...
    parser.add_argument("--prompt",type=str,default="instruction",help="JSON dataset key")
    parser.add_argument("--query",type=str,default="input",help="JSON dataset key")
    parser.add_argument("--output",type=str,default="output",help="JSON dataset key")
    ...
    parser.add_argument("--adam_offload",type=bool,default=False,help="Offload Adam Optimizer")
    parser.add_argument("--param_offload",type=bool,default=False,help="Offload model param")
